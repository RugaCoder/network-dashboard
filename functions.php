        ...
        <div class="headerStatus" style="text-align:center;">
			...
			if ( ( $hosts_total || $service_total ) == 0 ) { // No data in the arrays.
				...
				<div class="alert alert-down">
					<h3>There was a problem fetching data from Monitoring MK LiveStatus.</h3>
				</div>
				<?php
